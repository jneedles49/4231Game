...
public class ShadowObject : MonoBehaviour
{
    ...
    [SerializeField] private GameObject Object_Collider; 
	...
	switch(other.gameObject.tag){
		...
		case "ShadowWall":
			Make_Collider(other.gameObject);
			break;
		case "Ground":
			Delete_Colliders();
			break;
    ...
    private void Make_Collider(GameObject Collision_Object){
	    ...
	    GameObject Collision_Instance = Instantiate(Object_Collider);
